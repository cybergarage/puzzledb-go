...
var (
	...
	mReadLatency = prometheus.NewHistogram(prometheus.HistogramOpts{
		Name: "fdb_read_latency",
		Help: "FoundationDB read latency in milliseconds",
	})
	//nolint:exhaustruct
	mRangeReadLatency = prometheus.NewHistogram(prometheus.HistogramOpts{
		Name: "fdb_range_read_latency",
		Help: "FoundationDB range read latency in milliseconds",
	})
	//nolint:exhaustruct
	mWriteLatency = prometheus.NewHistogram(prometheus.HistogramOpts{
		Name: "fdb_write_latency",
		Help: "FoundationDB write latency in milliseconds",
	})
)
